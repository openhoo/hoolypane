 ...
 * - the desktop preload recorder derives implicit ARIA roles and must never emit a name outside
 *   this table (its IMPLICIT_ROLES subset is compile-pinned to this table via `satisfies`).
 */
